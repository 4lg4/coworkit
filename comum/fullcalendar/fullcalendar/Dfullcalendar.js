...
function BasicView(element, calendar, viewName) {
	...
	function buildTable(showNumbers) {
		...
		html += "<div class='fc-border-separate' style='width:100%' cellspacing='0'>" +
		        "<thead>" +
		        "<div>";

		if (showWeekNumbers) {
			html += "<divclass='fc-week-number " + headerClass + "'/>";
		}

		for (i=0; i<colCnt; i++) {
			html += "<divclass='fc-day-header fc-" + dayIDs[i] + " " + headerClass + "'/>";
		}
		...
		for (i=0; i<rowCnt; i++) {
			...
			if (showWeekNumbers) {
				html += "<div class='fc-week-number " + contentClass + "'>" +
				        "<div/>" +
				        "</div>";
			}
...
function AgendaView(element, calendar, viewName) {
	...
	function buildSkeleton() {
		...
		s =
			"<div style='width:100%' class='fc-agenda-days fc-border-separate' cellspacing='0'>" +
			"<thead>" +
			"<div>";

		if (showWeekNumbers) {
			s += "<divclass='fc-agenda-axis fc-week-number " + headerClass + "'/>";
		}
		else {
			s += "<divclass='fc-agenda-axis " + headerClass + "'>&nbsp;</div>";
		}

		for (i=0; i<colCnt; i++) {
			s +=
				"<divclass='fc- fc-col" + i + ' ' + headerClass + "'/>"; // fc- needed for setDayID
		}
		s +=
			"<divclass='fc-agenda-gutter " + headerClass + "'>&nbsp;</div>" +
			"</div>" +
			"</divead>" +
			"<tbody>" +
			"<div>" +
			"<divclass='fc-agenda-axis " + headerClass + "'>&nbsp;</div>";
		for (i=0; i<colCnt; i++) {
			s +=
				"<div class='fc- fc-col" + i + ' ' + contentClass + "'>" + // fc- needed for setDayID
				"<div>" +
		...
		s +=
			"<div class='fc-agenda-gutter " + contentClass + "'>&nbsp;</div>" +
			"</div>" +
			"</tbody>" +
			"</div>";
		...
		if (opt('allDaySlot')) {
			...
			s =
				"<div style='width:100%' class='fc-agenda-allday' cellspacing='0'>" +
				"<div>" +
				"<divclass='" + headerClass + " fc-agenda-axis'>" + opt('allDayText') + "</div>" +
				"<div>" +
				"<div class='fc-day-content'><div style='position:relative'/></div>" +
				"</div>" +
				"<divclass='" + headerClass + " fc-agenda-gutter'>&nbsp;</div>" +
				"</div>" +
				"</div>";
		...
		s =
			"<div class='fc-agenda-slots' style='width:100%' cellspacing='0'>" +
			"<tbody>";
		d = zeroDate();
		...
		for (i=0; d < maxd; i++) {
			...
			s +=
				"<div class='fc-slot" + i + ' ' + (!minutes ? '' : 'fc-minor') + "'>" +
				"<divclass='fc-agenda-axis " + headerClass + "'>" +
