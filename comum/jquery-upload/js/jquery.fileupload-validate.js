...
(function (factory) {
    ...
    $.widget('blueimp.fileupload', $.blueimp.fileupload, {
        ...
        options: {
            ...
            messages: {
                maxNumberOfFiles: 'Número máximo de arquivos por upload ultrapassado',
                acceptFileTypes: 'Tipo de arquivo não permitido',
                maxFileSize: 'Arquivo maior que o limite permitido',
                minFileSize: 'Arquivo menor que limite permitido'
            }
        },
