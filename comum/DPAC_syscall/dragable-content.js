	...
	*/	
	...
	function getLeftPos(inputObj)
	{
	  ...
	  return returnValue; // hack for Datawide
	...
	function initDragDropElement(e)
	{
		...
		//if(source.tagName.toLowerCase()=='input' || source.tagName.toLowerCase()=='textarea' || source.tagName.toLowerCase()=='checkbox' || source.tagName.toLowerCase()=='radio' || source.tagName.toLowerCase()=='iframe' || source.className.toLowerCase()=='ui_box' ||  source.id.toLowerCase()=='mycustomfloater')return;
		if(source.className.toLowerCase()!='ui_frame' && source.className.toLowerCase()!='ui_title')return;
