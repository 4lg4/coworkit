...
//    var curPosy = (e.y)?parseInt(e.y):parseInt(e.clientY);
   ...
   { newPosy= newPosy+ document.body.scrollTop + document.documentElement.scrollTop;
     newPosx = newPosx + document.body.scrollLeft + document.documentElement.scrollLeft;}
